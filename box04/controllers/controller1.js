					...
					for (y = 0; y <= myObj[x].texts.length; y++){
						//if( myObj[x].texts[y] ){ text += "" + myObj[x].texts[y] + "<br>";}
							...
							for (z = 0; z < myObj[x].texts[y].text.length; z++){
								if( myObj[x].texts[y].text[z] ){ text += "<h4>"+(z+1)+'. ' + myObj[x].texts[y].text[z].name +" <span style='color:red'>"  + myObj[x].texts[y].text[z].keyword + "</span></h4>" + myObj[x].texts[y].text[z].body ;}
							}
